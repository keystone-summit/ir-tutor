...
export const SEMINAR_FEEDS = [
  ...
  { name: "Reforma (GN)", url: "https://news.google.com/rss/search?q=when:7d+source:%22Reforma%22+Mexico&hl=en-US&gl=US&ceid=US:en", region: "MEX", worldview: "Mexican center-right daily" },
  { name: "El Universal (GN)", url: "https://news.google.com/rss/search?q=when:7d+source:%22El+Universal%22+Mexico&hl=en-US&gl=US&ceid=US:en", region: "MEX", worldview: "Mexican daily of record" },
  { name: "Caracas Chronicles", url: "https://www.caracaschronicles.com/feed/", region: "VEN", worldview: "Venezuelan opposition-aligned" },
  { name: "InSight Crime", url: "https://insightcrime.org/feed/", region: "INTL", worldview: "organized-crime investigation" },
  { name: "Borderland Beat", url: "https://www.borderlandbeat.com/feeds/posts/default?alt=rss", region: "MEX", worldview: "US-Mexico border / cartels OSINT" },

  // ---- Asia (India hedge + China financial press) (Phase 3.5) ----
  { name: "Hindustan Times World", url: "https://www.hindustantimes.com/feeds/rss/world-news/rssfeed.xml", region: "IND", worldview: "Indian mainstream daily" },
  { name: "Caixin (GN)", url: "https://news.google.com/rss/search?q=when:7d+source:%22Caixin%22&hl=en-US&gl=US&ceid=US:en", region: "PRC", worldview: "Chinese financial / markets press" },

  // ---- Russia incl. dissident / exile press (Phase 3.5; TASS already above) ----
  { name: "RT", url: "https://www.rt.com/rss/news/", region: "RUS", worldview: "Russian state broadcaster" },
  { name: "Meduza (English)", url: "https://meduza.io/rss/en/all", region: "RUS", worldview: "Russian dissident / exile press" },

  // ---- Africa (Phase 4 — the `africa` quota bucket had no dedicated source
  //      and was reported underweighted every week as a result) ----
  { name: "Africanews", url: "https://www.africanews.com/feed/rss", region: "AFR", worldview: "pan-African broadcaster" },
  { name: "Africa security (GN)", url: "https://news.google.com/rss/search?q=when:7d+Sahel+OR+%22Horn+of+Africa%22+OR+Nigeria+OR+Sudan+OR+Congo+security+OR+coup+OR+militants&hl=en-US&gl=US&ceid=US:en", region: "AFR", worldview: "Africa security wire (via Google News)" },

  // ---- South Asia (Phase 4; Hindustan Times already above) ----
  { name: "Dawn (Pakistan)", url: "https://www.dawn.com/feeds/home", region: "PAK", worldview: "Pakistani daily of record" },
  { name: "South Asia (GN)", url: "https://news.google.com/rss/search?q=when:7d+India+OR+Pakistan+OR+Bangladesh+OR+Afghanistan+foreign+policy+OR+border+OR+military&hl=en-US&gl=US&ceid=US:en", region: "SAS", worldview: "South Asia wire (via Google News)" },

  // ---- Global institutions / multilateral (Phase 4) ----
  { name: "UN News", url: "https://news.un.org/feed/subscribe/en/news/all/rss.xml", region: "UN", worldview: "United Nations" },
  { name: "Multilateral (GN)", url: "https://news.google.com/rss/search?q=when:7d+%22United+Nations%22+OR+%22Security+Council%22+OR+NATO+summit+OR+%22G7%22+OR+%22ICC%22+resolution&hl=en-US&gl=US&ceid=US:en", region: "UN", worldview: "multilateral wire (via Google News)" },

  // ---- Asia (financial / regional business press) ----
  { name: "Nikkei Asia (GN)", url: "https://news.google.com/rss/search?q=when:7d+source:%22Nikkei+Asia%22&hl=en-US&gl=US&ceid=US:en", region: "JPN", worldview: "Japanese financial press" },
